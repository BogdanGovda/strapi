...
export interface ApiExpertExpert extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    reviews: Schema.Attribute.Relation<
      'oneToMany',
      'api::reviews-list.reviews-list'
    >;
    schedule: Schema.Attribute.Component<'shared.schedule', true>;
    skills: Schema.Attribute.Component<'shared.professional-skill', true>;
    specialization: Schema.Attribute.Component<'shared.specializations', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiReviewsListReviewsList extends Struct.CollectionTypeSchema {
  collectionName: 'reviews_lists';
  info: {
    displayName: 'reviewsList';
    pluralName: 'reviews-lists';
    singularName: 'reviews-list';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiVaccineCategoryVaccineCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'vaccine_categories';
  info: {
    displayName: 'VaccineCategory';
    pluralName: 'vaccine-categories';
    singularName: 'vaccine-category';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    itemList: Schema.Attribute.Component<'shared.vaccine-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vaccine-category.vaccine-category'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::reviews-list.reviews-list': ApiReviewsListReviewsList;
      'api::vaccine-category.vaccine-category': ApiVaccineCategoryVaccineCategory;
